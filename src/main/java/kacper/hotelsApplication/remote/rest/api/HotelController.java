...
import kacper.hotelsApplication.remote.rest.dto.response.HotelCollectionDto;
import kacper.hotelsApplication.remote.rest.dto.response.HotelDto;
import kacper.hotelsApplication.remote.rest.dto.response.RoomDto;
...
public class HotelController {
    ...
    public ResponseEntity<HotelCollectionDto> getHotel() {
        RoomDto roomDto = new RoomDto(1, "3", BigDecimal.valueOf(30.20));
